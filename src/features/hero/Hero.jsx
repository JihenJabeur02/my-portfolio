...
<SectionWrapper
  id="home"
  className="relative grid place-content-center overflow-hidden h-screen pt-28 sm:pt-32"
  variant="static"
>
  ...
  <div className="relative z-10 flex flex-col items-center text-center px-4 py-4 sm:py-6">
    <div className="relative w-full flex justify-center mb-8 sm:mb-10">
    ...
    <div className="mt-10 flex justify-center gap-12 sm:gap-20">
      {[
